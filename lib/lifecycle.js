...
export function buildMagazineLifecycle(article = {}) {
  return cleanTimeline([
    timelineItem({
      ...
      description: "Student writing entered the school review queue.",
    }),
    timelineItem({
      label: "Resubmitted after revision",
      status: "RESUBMITTED",
      at: article.lastResubmittedAt,
      description: `Revision ${Number(article.revisionCount || 0)} sent back to school.`,
    }),
    timelineItem({
      label:
