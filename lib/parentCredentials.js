...
async function completeSignIn(parent, { language } = {}) {
  ...
  // A Parent ID works as soon as the school assigns it. Printing or showing a
  // QR is only another way to share that same ID, not a separate activation
  // gate. Revoked accounts remain blocked by the check above.
