    ...
    <div className="space-y-5">
      <section className="rounded-2xl border border-[#e6eaf7] bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <span className="rounded-lg bg-[#f4f1ff] px-4 py-2 text-sm font-black text-[#4326e8]">
            {counts.total} total
          </span>
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                ...
                {item.status === "NEW" && (
                  <button
                    ...
                    className="inline-flex min-h-10 items-center justify-center gap-2 rounded-lg bg-[#4326e8] px-4 text-sm font-black text-white disabled:opacity-60"
                    style={{ color: "#ffffff" }}
                  >
