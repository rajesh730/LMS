...
export default function NotFound() {
  return (
    <main className="pravyo-page-shell flex min-h-screen items-center justify-center px-4 py-16">
      <div className="pravyo-card mx-auto max-w-lg p-8 text-center sm:p-10">
        ...
        <p className="pravyo-eyebrow mt-6">Page not found</p>
        <h1 className="pravyo-heading mt-3 text-3xl">This page does not exist</h1>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/"
            className="pravyo-btn-primary inline-flex items-center gap-2 rounded-lg bg-[var(--brand-primary)] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[var(--brand-primary-hover)]"
          >
            <FaHome />
            Go to homepage
          </Link>
